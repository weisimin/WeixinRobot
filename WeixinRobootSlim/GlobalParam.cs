...
namespace WeixinRoboot
{
    ...
    //    public bool RobotProcess
    //    {
    //        get { return _RobootProcess; }
    //        set
    //        {
    ...
    //                  && t.WX_SourceType == "QQ"
    //                  && t.WX_UserName == 窗口名字.Replace("智能发图", "")
    //                  );

    //            if (set == null)
    //            {
    //                Linq.WX_WebSendPICSetting newset = new Linq.WX_WebSendPICSetting();
    //                newset.aspnet_UserID = GlobalParam.UserKey;
    //                newset.WX_SourceType = "QQ";
    //                newset.WX_UserName = 窗口名字.Replace("智能发图", "");
    ...
    //    private bool _RobootProcess = false;
    //}
